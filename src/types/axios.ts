...
export declare class AxiosHeaders {
...
export declare class AxiosError<T = unknown, D = any> extends Error {
  constructor(
    message?: string,
    code?: string,
    config?: InternalAxiosRequestConfig<D>,
...
export declare function getAdapter(adapters: AxiosAdapterConfig | AxiosAdapterConfig[] | undefined): AxiosAdapter;

export declare function toFormData(
  sourceObj: object,
  targetFormData?: GenericFormData,
  options?: FormSerializerOptions
): GenericFormData;

export declare function formToJSON(form: GenericFormData | GenericHTMLFormElement): object;

export declare function isAxiosError<T = any, D = any>(payload: any): payload is AxiosError<T, D>;

export declare function spread<T, R>(callback: (...args: T[]) => R): (array: T[]) => R;

export declare function isCancel(value: any): value is Cancel;

export declare function all<T>(values: Array<T | Promise<T>>): Promise<T[]>;

export declare function mergeConfig<D = any>(
