...
<div class="center-notice">
  ...
  <h1>No bug reports!</h1>
  <p>There are no bug reports in your account! If you want, you can submit your first one here:</p>
  <button onclick={() => process.notImplemented()}>Submit a bug</button>
</div>
