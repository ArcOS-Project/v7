<script lang="ts">
  ...
  let timestamp = $state(dayjs(activity.createdAt).format("ddd D MMM, HH:mm:ss"));
</script>

<div class="activity-item">
  <div class="icon">
    <span class="lucide icon-{ActivityIconTranslations[activity.action] || 'shield-question'}"></span>
  </div>
  <div class="info">
    <p class="what">
      <span>
    ...
    <p class="ua">
      <span class="user-agent" title={activity.userAgent}>{activity.userAgent}</span>
    </p>
